...
public class UserServiceUnitTest {
    ...
    public void getVerifiedUser_success() throws Exception {
        //given
        given(userRepository.findById(userId)).willReturn(Optional.of(user));

        //when
        UserResponse userResponse = userService.getVerifiedUser(userId, email);
    ...
    public void getVerifiedUser_fail_access_denied() throws Exception {
        //given
        given(userRepository.findById(userId)).willReturn(Optional.of(user));

        //when
        //then
        assertThatThrownBy(() -> userService.getVerifiedUser(userId, "wrong" + email))
